...
public class AuthView extends JFrame implements ActionListener{
    ...
    JLabel lAuth = new JLabel("LOGIN", SwingConstants.CENTER);
    
    JLabel lUsername = new JLabel("Username", SwingConstants.LEFT);
